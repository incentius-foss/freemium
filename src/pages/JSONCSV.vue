      ...
      <div class="full-width flex justify-between row wrap justify-around items-start content-end">
        <div class="col-5" style="overflow:auto">
          ...
          <q-card-actions vertical align="center">
            <q-input class="full-width form-control bg-white pl-5" v-model="csvjson" placeholder="Enter JSON Data"
                     ref="textarea"
                     rows="27"
                     type="textarea"/>
          </q-card-actions>
...
export default {
  ...
  methods: {
    ...
    sample() {
      this.csvjson = '{"sample_data": "sample_data", "data": "data", "name": "json"}'
    },
    downloadCSV() {
