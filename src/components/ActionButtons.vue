<template>
  <div class="tw-flex tw-gap-2">
    <q-btn dense
           type="a"
           href="https://github.com/incentius-foss/freemium"
           target="_blank"
    ...
    <q-btn dense
           type="a"
           href="https://www.linkedin.com/company/incentius"
           target="_blank"
           unelevated class="tw-rounded-lg tw-bg-white/10 tw-p-1">
...
export default defineComponent({
  ...
  methods:{
    shareURL(){
      const url = 'https://freemium.incentius.com'
      const text = 'Check out this awesome tool to beautify and minify your code'
      const hashtags = 'freemium,devutils'
      const via = 'incentius'
